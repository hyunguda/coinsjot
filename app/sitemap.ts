...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    { url: BASE,               lastModified: new Date("2026-09-18"), changeFrequency: "weekly", priority: 1 },
    { url: `${BASE}/insights`, lastModified: new Date("2026-09-18"), changeFrequency: "weekly", priority: 0.9 },
    ...calculators,
    ...insightPages,
